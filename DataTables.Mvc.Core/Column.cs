...
namespace DataTables.Mvc.Core
{
    public class Column
    {
        ...
        public Column Image(string image, string alt, string title, string sortData = null)
        {
            ...
            builder.AppendLine(String.Format("return '<img src=\"{0}\" alt=\"{1}\" title=\"{2}\"/>';", image, alt, title));
            builder.AppendLine("}");
